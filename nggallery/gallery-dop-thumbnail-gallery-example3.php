...
<!--    
    var DOPNextGENThumbnailGallerySettings<?php echo $gallery->ID;?> = {
        ...
        "ThumbnailsBgAlpha": 50, // Thumbnails Background Alpha (value from 0 to 100). Default value: 100. Set the transparency for the thumbnails background.
        ...
        "ThumbnailWidthMobile": 50, // Mobile Thumbnail Width (the size in pixels). Default value: 60. Set the width of a thumbnail on mobile devices.
