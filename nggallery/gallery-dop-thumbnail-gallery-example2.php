...
<!--    
    var DOPNextGENThumbnailGallerySettings<?php echo $gallery->ID;?> = {
        ...
        "ThumbnailsPosition": "left", // Thumbnails Position (top, right, bottom, left). Default value: bottom. Set the position of the thumbnails in the gallery.
        ...
        "ThumbnailWidth": 150, // Thumbnail Width (the size in pixels). Default value: 60. Set the width of a thumbnail.
        "ThumbnailHeight": 100, // Thumbnail Height (the size in pixels). Default value: 60. Set the height of a thumbnail.
        "ThumbnailWidthMobile": 75, // Mobile Thumbnail Width (the size in pixels). Default value: 60. Set the width of a thumbnail on mobile devices.
        "ThumbnailHeightMobile": 50, // Mobile Thumbnail Height (the size in pixels). Default value: 60. Set the height of a thumbnail on mobile devices.
        "ThumbnailAlpha": 100, // Thumbnail Alpha (value from 0 to 100). Default value: 50. Set the transparency of a thumbnail.
        ...
        "ThumbnailBgColorHover": "f1f1f1", // Thumbnail Background Color Hover (color hex code). Default value: 000000. Set the color of a thumbnail's background when hover.
        "ThumbnailBgColorSelected": "f1f1f1", // Thumbnail Background Color Selected (color hex code). Default value: 000000. Set the color of a thumbnail's background when selected.
        ...
        "ImageBgColor": "f1f1f1", // Image Background Color (color hex code). Default value: afafaf. Set the color for the image background.
        ...
        "ImageDisplayType": "fit", // Image Display Type (fit, full). Default value: fit. Set image display type. The fit value will display the all image. The full value will display the image on the all stage, padding and margin values will not be taken into consideration.
        ...
        "ImageMarginLeft": 50, // Image Margin Left (value in pixels). Default value: 20. Set top left value for the image.
        ...
        "CaptionWidth": 300, // Caption Width (value in pixels). Default value: 900. Set caption width.
        "CaptionHeight": 150, // Caption Height (value in pixels). Default value: 75. Set caption height.
        ...
        "CaptionPosition": "top-left", // Caption Position (top, right, bottom, left, top-left, top-right, bottom-left, bottom-right). Default value: bottom. Set caption position.
        ...
        "CaptionMarginTop": 10, // Caption Margin Top (value in pixels). Default value: 0. Set caption top margin.
...
<!--    
    jQuery(document).ready(function(){
        jQuery('#DOPNextGENThumbnailGallery<?php echo $gallery->ID; ?>').DOPNextGENThumbnailGallery();
    });
//-->    
</script>
<?php
