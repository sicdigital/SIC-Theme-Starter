...
<!--    
    var DOPNextGENThumbnailGallerySettings<?php echo $gallery->ID;?> = {
        ...
        "ThumbnailsPaddingBottom": 5, // Thumbnails Padding Bottom (value in pixels). Default value: 5. Set the bottom padding for the thumbnails.
        ...
        "ThumbnailWidth": 60, // Thumbnail Width (the size in pixels). Default value: 60. Set the width of a thumbnail.
