...
function sic_option($param, $required = "TRUE")
{
	
	global $Redux_Options;
	$options_array = $Redux_Options->options;	
	$option = $options_array[$param];
	
	
// use sic_option('all') to see all possible options var_dumped
	if($param == "all"){
		$options_array = $Redux_Options->options;	
		echo "<pre>";
